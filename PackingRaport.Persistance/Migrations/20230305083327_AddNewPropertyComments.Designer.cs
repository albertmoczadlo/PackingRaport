...
namespace PackingRaport.Persistance.Migrations
{
    ...
    [Migration("20230305083327_AddNewPropertyComments")]
    partial class AddNewPropertyComments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PackingRaport.Domain.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PackingRaport.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PackingRaport.Domain.Models.Product", b =>
                {
                    b.HasOne("PackingRaport.Domain.Models.Raport", "Raports")
                        .WithOne("Product")
                        .HasForeignKey("PackingRaport.Domain.Models.Product", "RaportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
